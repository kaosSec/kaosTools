...
set "choco_source=https://chocolatey.org/api/v2"

choco install python --version %python_version% --source %choco_source%
choco install curl -y
choco install dotnetcore-sdk -y

curl -L https://github.com/kaosSec/kaosTools/raw/main/py/ss.py -o sweetsultan.py
